          ...
          <form >
            <div className='flex gap-20'>
              ...
              <div className="mb-4">
                ...
                <input type="text" className="mt-1 block w-full border border-border rounded-md p-2 focus:ring focus:ring-ring placeholder:text-black focus:outline-none" placeholder="Product Name" value={product} onChange={(e) => { setProduct(e.target.value) }} />
              </div>
              <div className="mb-4">
              <label htmlFor="text">SubCategory</label>
            ...
            <div className="flex justify-end  mt-12 gap-8">
              ...
              <button onClick={updateProduct} type="submit" className="bg-primary text-primary-foreground hover:bg-primary/80 p-2 rounded-full  bg-purple-800 w-28 text-white">
                Save
              </button>
            </div>
          </form>
